...
class _HomePageState extends State<HomePage> {
  ...
  final List<Bat> bats = [
    ...
    Bat(
      id: "bat6",
      name: "Eidolon helvum",
      image: "assets/images/Eidolon helvum.png",
      info:
          "Large fruit bat with a distinctive straw-colored fur, found in tropical Africa.",
      soundType: "Social calls",
    ),
    Bat(
      id: "bat7",
      name: "Hipposideros curtus",
      image: "assets/images/Hipposideros curtus.png",
      info:
          "Small to medium-sized bat with a distinctive leaf-shaped nose, found in tropical Africa.",
      soundType: "Echolocation",
    ),
    Bat(
      id: "bat8",
      name: "Doryrhina cyclops",
      image: "assets/images/Doryrhina cyclops.png",
      info:
          "Medium-sized bat with a distinctive round leaf-shaped nose, found in tropical Africa.",
      soundType: "Distress",
    ),
    Bat(
      id: "bat9",
      name: "Rhinolophus landeri",
      image: "assets/images/Rhinolophus landeri.jpg",
      info:
          "Medium-sized horseshoe bat with a distinctive horseshoe-shaped noseleaf, found in Africa.",
      soundType: "Echolocation",
    ),
    Bat(
      id: "bat10",
      name: "Nycteris sp",
      image: "assets/images/Nycteris_thebaica.jpg",
      info:
          "Medium-sized bat with a distinctive slit-like facial groove, found in Africa and Asia.",
      soundType: "Echolocation",
    ),
  ];
